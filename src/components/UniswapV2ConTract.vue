  ...
  console.error("Invalid Address:", error);
    ...
    const getAmountOut = async (amountIn) => {
      try {
        ...
        // 更新到页面上
        amountOut.value = amounts[1].toString();
      } catch (error) {
